...
export default function CompetitionRegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch('/api/competition/auth/register', {
        method: 'POST',
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          <div className="text-center mb-8">
            ...
            <p className="text-muted">Register to participate in the Vishvakarma Innovation Challenge 2026</p>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-xl border border-border bg-card text-foreground placeholder:text-muted/60 focus:outline-none focus:ring-2 focus:ring-purple/50"
                />
              ...
              <p className="text-center text-sm text-muted">
                ...
                <Link href="/competition/login" className="text-purple hover:underline font-medium">
                  Login here
                </Link>
              </p>
            </form>
