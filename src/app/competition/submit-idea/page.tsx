...
export default function CompetitionSubmitIdeaPage() {
  const router = useRouter();
  const { isAuthenticated, checkAuth, isLoading } = useAuthStore();
  const STORAGE_KEY = 'vishvakarma_competition_submit_draft';
  ...
  useEffect(() => {
    if (!isLoading && !isAuthenticated) {
      router.push('/login?redirect=/competition/submit-idea');
    }
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const payload = {
        ...
        // No funding fields for competition submissions
      };
    ...
    <div className="min-h-screen pt-24 pb-16">
      <div className="max-w-3xl mx-auto px-4 sm:px-6">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-10">
          ...
          <h1 className="text-3xl md:text-4xl font-bold text-foreground mb-2">Submit Your Startup</h1>
          <p className="text-muted">Register your innovation for the Vishvakarma Innovation Challenge 2026</p>
        </motion.div>
            ...
            <Card className="p-6 md:p-8">
              ...
              {step === 0 && (
                <div className="space-y-5">
                  <h2 className="text-xl font-semibold text-foreground mb-4">Tell us about your startup</h2>
                  <Input
                ...
                <div className="space-y-5">
                  ...
                  <div className="p-4 bg-blue/5 border border-blue/10 rounded-xl">
                    <p className="text-sm text-muted">
                      Your product stage helps judges understand where you are in development.
                      Be honest — this builds trust with the evaluation panel.
                    </p>
                  </div>
              ...
              {step === 4 && (
                <div className="space-y-5">
                  <h2 className="text-xl font-semibold text-foreground mb-4">Showcase your startup</h2>
                  <Input
